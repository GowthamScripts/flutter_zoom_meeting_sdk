package com.flutterzoom.meeting_sdk;
...
public class FlutterZoomMeetingSdkPlugin implements FlutterPlugin, MethodCallHandler, ActivityAware, ZoomSDKAuthenticationListener {
    ...
    public void onAttachedToEngine(@NonNull FlutterPluginBinding flutterPluginBinding) {
        ...
        channel = new MethodChannel(flutterPluginBinding.getBinaryMessenger(), "plugins.flutter_zoom_meeting_sdk/zoom_channel");
        channel.setMethodCallHandler(this);

        meetingStatusChannel = new EventChannel(flutterPluginBinding.getBinaryMessenger(), "plugins.flutter_zoom_meeting_sdk/zoom_event_stream");
    }
    ...
    /**
     * Join meeting using JoinMeetingParam4WithoutLogin (SDK 6.6.11 API)
     */
    private void joinMeeting(MethodCall methodCall, MethodChannel.Result result) {
        ...
        if (!zoomSDK.isInitialized()) {
            System.out.println("Zoom SDK not initialized");
        ...
        // Use JoinMeetingParam4WithoutLogin for SDK 6.6.11
